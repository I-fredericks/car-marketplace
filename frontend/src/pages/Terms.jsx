...
const Terms = () => {
  useSEO({
    ...
    description: 'The rules for buying, selling and using the SikaRide marketplace.',
  });
    ...
    <div className="bg-bg min-h-screen pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <Section title="1. Agreement">
          <p>
            By using SikaRide ("SikaRide", the "platform"), you agree to these terms.
            SikaRide is a marketplace that connects private sellers, dealers and buyers of
            vehicles in Ghana. SikaRide is not a party to any sale between users.
          </p>
        </Section>
        ...
        <Section title="3. Listings">
          <p>
            ...
            SikaRide reviews, approves, rejects or removes listings at its discretion.
          </p>
        </Section>
        ...
        <Section title="5. Buying and communicating on SikaRide">
          <p>
            SikaRide facilitates contact between buyers and sellers but does not verify
            ownership, condition or roadworthiness unless a listing carries a SikaRide
        ...
        <Section title="7. Liability">
          <p>
            ...
            SikaRide is not liable for losses arising from transactions between users,
        ...
        <Section title="9. Contact">
          <p>
            ...
            <a href="mailto:support@sikaride.com" className="text-primary hover:underline">support@sikaride.com</a>.
          </p>
        </Section>
      </div>
    </div>
