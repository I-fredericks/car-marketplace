...
const Checkout = () => {
  ...
  // Car payments ride FLAT-FEE rails into AutoTrustGhana's own collection
    ...
    <div className="bg-bg min-h-screen pt-24 pb-20 px-4">
      <div className="max-w-4xl mx-auto grid md:grid-cols-[1fr,380px] gap-6">
        ...
        <div className="bg-surface border border-bordercol rounded-xl p-6 shadow-sm">
          ...
          {/* Payment — flat-fee rails into AutoTrustGhana's escrow account */}
          ...
          <div className="grid grid-cols-1 gap-3 mb-4">
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-medium text-textprimary">Bank transfer to AutoTrustGhana</span>
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="font-medium text-textprimary">Mobile Money to AutoTrustGhana</span>
              </div>
              <p className="text-xs text-textsecondary leading-relaxed">
          ...
          {payMode === 'CASH' && (
            <div className="mb-6 border-2 border-warn/40 bg-warn/5 rounded-lg p-4">
              ...
              <ul className="text-xs text-textsecondary leading-relaxed space-y-1.5 list-disc list-inside">
                <li>Cash payments happen <span className="font-semibold">outside</span> AutoTrustGhana.</li>
