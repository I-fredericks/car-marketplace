 ...
 * SikaRide from classifieds. Every claim below is backed by shipped
 * mechanics — escrow hold, 1% fee, dispute mediation, condition facts.
 */
const BuyerProtection = () => {
  useSEO({
    title: 'Buyer Protection Guarantee',
    description: 'Your money is held in escrow until you confirm you have the car. If anything goes wrong, SikaRide mediates and refunds.',
  });
  ...
  const steps = [
    {
      ...
      body: 'Your money goes to SikaRide\'s account — never directly to the seller. Bank transfer and MoMo keep it flat-fee; we take just 1% when the sale completes.',
    },
    {
      icon: Search,
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-success/10 text-success px-4 py-1.5 rounded-full text-sm font-bold mb-4">
            <ShieldCheck size={16} /> The SikaRide Guarantee
          </div>
          ...
          <p className="text-textsecondary text-lg max-w-2xl mx-auto leading-relaxed">
            On every other site you meet a seller, pay cash, and pray. On SikaRide your money is held
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-12">
          <div className="bg-surface border border-success/25 rounded-xl p-6">
            ...
            <ul className="space-y-2.5 text-sm text-textsecondary">
              ...
              <li className="flex gap-2"><CheckCircle size={15} className="text-success flex-shrink-0 mt-0.5" /> Full refund resolved by SikaRide when the claim holds</li>
            </ul>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-textmuted mt-4">
            Guarantee applies to orders paid through SikaRide escrow (bank transfer / Mobile Money).
          </p>
        </div>
      </div>
    </div>
