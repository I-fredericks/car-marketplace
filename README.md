...
Live: **https://drivehubcars.com** (domain to be purchased and attached in Vercel; currently served at https://car-marketplace-five-ruby.vercel.app) · API: **https://carmarket-api-uk2b.onrender.com**

When the custom domain is attached in Vercel, also update (no code changes needed):
1. Render `FRONTEND_URL` → `https://drivehubcars.com,https://car-marketplace-five-ruby.vercel.app` (CORS allowlist — comma-separated, keep both origins)
2. Google Cloud Console → OAuth client → Authorized JavaScript origins: add `https://drivehubcars.com`
